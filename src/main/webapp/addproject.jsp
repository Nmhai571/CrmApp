                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="projectname" name="projectname" type="text" placeholder="Tên công việc"
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button id="btn-addproject" type="submit" class="btn btn-success">Lưu lại</button>
                                        <a href="projecttable" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
