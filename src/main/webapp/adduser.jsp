                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action=" "  method="post">
                            	<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="iduser" name="iduser" type="hidden" placeholder="Full Name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="password"
                                        name="password" type="password" value="password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" >
                                    <div class="col-sm-12">
                                        <button id="btn-adduser" type="submit" class="btn btn-success">Add User</button>
